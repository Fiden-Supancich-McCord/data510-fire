...
![SHAP values for a Random Forest classifier with prescribed burn, Indigenous designation, and plant sum.](/images/shap_summary_ndgn_plnt_rx.png){#fig-shap-summary}
...
![SHAP values for Random Forest classifier with added wildfire metrics.](/images/shap_summary_ndgn_plnt_rx_wf.png){#fig-shap-summary-wf}
...
![SHAP values for the Random Forest classifier with all plant species counts included separately.](/images/shap_summary_ndgn_plnt_rx_wf_p.png){#fig-shap-summary-plant}
...
![Confusion matrix for the Random Forest classifier.](/images/conf_matrix_ndgn_plnt_rx.png){#fig-conf-matrix}
...
![Confusion matrix for the Random Forest classifier with wildfire metrics.](/images/conf_matrix_ndgn_plnt_rx_wf.png){#fig-conf-matrix}
...
![Confusion matrix for the Random Forest classifier with all plant species counts included separately.](/images/conf_matrix_ndgn_plnt_rx_wf_p.png){#fig-conf-matrix-plant}
